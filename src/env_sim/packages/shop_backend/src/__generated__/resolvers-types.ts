...
export type Homepage = {
  ...
  readonly banners: ReadonlyArray<Image>;
  readonly hero: Maybe<Image>;
};
...
export type HomepageResolvers<ContextType = ResolverContext, ParentType extends ResolversParentTypes['Homepage'] = ResolversParentTypes['Homepage']> = {
  banners?: Resolver<ReadonlyArray<ResolversTypes['Image']>, ParentType, ContextType>;
  hero?: Resolver<Maybe<ResolversTypes['Image']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
