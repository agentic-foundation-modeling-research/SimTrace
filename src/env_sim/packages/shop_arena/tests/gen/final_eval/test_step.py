"""Unit tests for :mod:`shop_arena.gen.final_eval.step` (T6.3).
...
Spec contract under test (``docs/specs/shop_arena/shop_arena.gen.md`` §5.5.5):
...
def test_final_eval_step_visual_error_when_skill_unavailable(
    ...
    with caplog.at_level("WARNING", logger="shop_arena.gen.final_eval.visual_sweep"):
        step.run(_build_ctx(out_dir, runtime=runtime))
